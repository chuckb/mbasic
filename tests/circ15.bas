10 PRINT "Starting test with";15;"nested GOSUBs"
20 GOSUB 1000
...
1930 RETURN
2000 PRINT "Enter level 11"
2010 GOSUB 2100
2020 PRINT "Return from level 11"
2030 RETURN
2100 PRINT "Enter level 12"
2110 GOSUB 2200
2120 PRINT "Return from level 12"
2130 RETURN
2200 PRINT "Enter level 13"
2210 GOSUB 2300
2220 PRINT "Return from level 13"
2230 RETURN
2300 PRINT "Enter level 14"
2310 GOSUB 2400
2320 PRINT "Return from level 14"
2330 RETURN
2400 PRINT "Enter level 15"
2420 PRINT "Return from level 15"
2430 RETURN
